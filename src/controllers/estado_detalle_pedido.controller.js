...
export const getEstadosPosicionPedido = async (req,res) =>{
    try {
        ...
        const[rows] = await pool.query('select b.orden, b.descripcion descripcion_estado, a.* from t_estado_pedido a join t_estado b on b.id=a.t_estado_id where t_detalle_pedido_id=?',[req.params.id])
